...
Assignment: Lab 12
Date: 4-26-18
Description: This program declares a class for a circle that will have member functions 
        that set the center, find the area, find the circumference and display these
        attributes. The program as written does not allow the user to input data, but
        rather has the radii and center coordinates of the circles (spheres in the program)
        initialized at definition or set by a function.
*/
#include <iostream>
using namespace std;
