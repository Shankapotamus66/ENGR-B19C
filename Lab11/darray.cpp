...
Date: 4-17-18
Description: This program prompts the user to input how many months will be averaged, then
		allow the user to input the sales amount for each month and then computes the average.
*/
