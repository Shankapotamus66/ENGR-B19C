...
Description: This program prompts the user to enter 3 intergers, then uses a function to
        ...
        This program uses pass by value for the function.
*/
...
void displayLowest(int one, int two, int three);
void displayHighest(int one, int two, int three);
...
int main()
{
    ...
    displayLowest(one, two, three);
    displayHighest(one, two, three);
...
void displayLowest(int one, int two, int three) // one is the lowest value after being sorted
{
    int temp;
    if (one > two) 
    {
...
void displayHighest(int one, int two, int three) // three is the highest value after being sorted
{
    int temp;
    if (one > two) 
    {
